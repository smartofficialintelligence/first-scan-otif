            ...
            ledger.append_outcome(
                {
                    ...
                    "observed_days_late": action.observed_days_late,
                    "simulated_days_late": action.simulated_days_late,
                    "simulated_delay_days_avoided": action.simulated_delay_days_avoided,
        ...
        ledger.append_outcome(
            {
                ...
                "observed_days_late": result.observed_days_late,
                "simulated_days_late": result.simulated_days_late,
                "simulated_delay_days_avoided": result.simulated_delay_days_avoided,
