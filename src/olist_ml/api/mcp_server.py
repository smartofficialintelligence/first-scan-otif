...
def _score_kwargs(
    *,
    ...
    return {
        ...
        "seller_avg_freight_30d": seller_avg_freight_30d,
        "seller_avg_freight_90d": seller_avg_freight_90d,
        "seller_avg_basket_30d": seller_avg_basket_30d,
        "seller_avg_basket_90d": seller_avg_basket_90d,
        "customer_order_count_30d": customer_order_count_30d,
        "customer_order_count_90d": customer_order_count_90d,
        "customer_late_rate_90d": customer_late_rate_90d,
        "category_late_rate_30d": category_late_rate_30d,
        "category_late_rate_90d": category_late_rate_90d,
        "category_order_count_90d": category_order_count_90d,
...
def create_mcp_server():
    ...
    def _predict_impl(
        ...
        """Score promise-miss risk at carrier handoff (same path as REST /v1/predict)."""
    ...
    server.tool(name="predict_promise_miss")(_predict_impl)
    ...
    server.tool(name="explain_promise_miss")(_explain_impl)
    server.tool(name="get_order_risk")(_predict_impl)
